...
import { ASPECT_RATIOS, APP_VERSION, BUILD_DATE } from '../constants';
...
export const RenderSettingsPanel: React.FC<RenderSettingsProps> = ({ 
  settings, onChange, darkMode, onToggleDarkMode, weekStartsOn, onToggleWeekStart, onResetProject, onVersionClick 
}) => {
      ...
      <div className="space-y-6">
        ...
        <div className="pt-4 text-center">
            <button 
               ...
               className="text-[10px] text-slate-400 dark:text-slate-600 font-mono tracking-wider hover:text-blue-500 hover:underline cursor-pointer transition-colors"
            >
